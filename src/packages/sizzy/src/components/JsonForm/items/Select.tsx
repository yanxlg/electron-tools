...
export type SelectProps<T = string> = FormItemLabelProps &
    CustomFormProps & {
        ...
        'loading' | 'onChange' | 'className' | 'options'
    >;
...
const FormSelect = (props: SelectProps) => {
    ...
    const [options, setOptions] = useState<IOptionItem[] | undefined>(
        undefined,
    );
                ...
                <Form.Item
                    ...
                    shouldUpdate={(prevValues, currentValues) => {
                        ...
                        while (!updated && i < length) {
                            const dependenceName = dependenceNameList[i];
                            updated =
                                prevValues[dependenceName] !==
                                currentValues[dependenceName];
                            i++;
                        }
                        return updated;
                    }}
