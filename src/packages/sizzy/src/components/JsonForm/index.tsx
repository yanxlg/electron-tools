...
import DynamicItem, {
    DynamicItemProps,
    DynamicType,
} from './items/DynamicItem';
import HideItem, { HideItemProps, HideType } from './items/HideItem';
import formatter, { Formatters, FormatterType } from '../../utils/formatter';
...
import CustomFragment, {
    CustomFragmentProps,
    CustomFragmentType,
} from './items/CustomFragment';
...
const JsonForm: ForwardRefRenderFunction<JsonFormRef, JsonFormProps> = (
    props,
    ref,
) => {
    const {
            ...
            (target as any[]).map((field: any) => {
                ...
                if (Layout.typeList.includes(type)) {
                    ...
                    const _value = getValues([
                        (field as DynamicItemProps).dynamic(form),
                    ]);
                    values = {
                        ...values,
                        ..._value,
